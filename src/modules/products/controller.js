...
const { createProduct, getProduct, getProducts, deleteProduct, updateProduct} = require("./service")
...
const update = async (req,res,next)=>{
  ...
  try {
    ...
    return response({ res, statusCode: httpStatus.OK, data:null,message:`Product with ID ${id} updated successfully.` })
...
const remove = async (req,res,next)=>{
  ...
  try {
    ...
    return response({ res, statusCode: httpStatus.OK, data:null,message:"Successfully deleted" })
